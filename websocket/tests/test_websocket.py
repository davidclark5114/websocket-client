...
class WebSocketTest(unittest.TestCase):
    ...
    def testParseUrl(self):
        ...
        p = parse_url("ws://www.mybthub.com/")
        self.assertEqual(p[0], "www.mybthub.com")
        self.assertEqual(p[1], 80)
        ...
        p = parse_url("ws://www.mybthub.com:8080/r")
        self.assertEqual(p[0], "www.mybthub.com")
        self.assertEqual(p[1], 8080)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], False)

        p = parse_url("ws://www.mybthub.com:8080/")
        self.assertEqual(p[0], "www.mybthub.com")
        self.assertEqual(p[1], 8080)
        self.assertEqual(p[2], "/")
        self.assertEqual(p[3], False)
        ...
        p = parse_url("wss://www.mybthub.com:8080/r")
        self.assertEqual(p[0], "www.mybthub.com")
        self.assertEqual(p[1], 8080)
        self.assertEqual(p[2], "/r")
        self.assertEqual(p[3], True)

        p = parse_url("wss://www.mybthub.com:8080/r?key=value")
        self.assertEqual(p[0], "www.mybthub.com")
        self.assertEqual(p[1], 8080)
